                                ...
                                <div class="navbar">
                                    <div class="navbar-inner">
                                        <ul class="bwizard-steps-o">
                                            ...
                                            <li><a href="#tab2-wizard-custom-circle" data-toggle="tab"><i class="fa fa-microphone"></i><p class="anchor">第一次面试</p></a>
                                            </li>
                                            <li><a href="#tab3-wizard-custom-circle" data-toggle="tab"><i class="fa fa-microphone"></i><p class="anchor">第二次面试</p></a>
                                            </li>
                                            <li>
                                                <a href="###">
